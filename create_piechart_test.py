...
def create_piechart(dataframe, colname):
    ...
    wedges, text, _ = ax1.pie(count, autopct='%1.1f%%',colors=colors, pctdistance=0.9, labeldistance=0.6, textprops={'fontsize': 10} , radius=0.9, startangle=5)
    ...
    #ax1.axis('equal')  
    #plt.tight_layout()
    plt.savefig('crossword_test_piechart')
    plt.savefig('crossword_test_piechart.pdf')
    plt.show()
